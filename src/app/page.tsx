    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-100 text-slate-800 px-6 py-12 max-w-5xl mx-auto font-sans">
      ...
      >
        ...
        <p className="text-slate-700 leading-relaxed max-w-2xl">
          I&apos;m a student of <strong className="font-bold">Electrical and Computer Engineering</strong> focused on embedded systems, firmware, and digital logic. My curriculum spans real-time task scheduling with <strong className="font-bold">FreeRTOS</strong>, wireless sensor networks with <strong className="font-bold">ESP-NOW</strong>, CPU design in <strong className="font-bold">SystemVerilog</strong>. I&apos;m driven by elegant system-level problem-solving that bridges hardware and software. I have taken additional coursework in Database Management, Data Structures & Algorithms, Artificial Intelligence, tinyML, and Neural Engineering to bolster my proffesional skillsets.
        </p>
      </motion.section>
